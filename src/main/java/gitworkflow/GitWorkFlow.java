...
public class GitWorkFlow {
    ...
    public static void main(String[] args) {
        ...
        String step5 = "Perform git checkout -b new_branch_name command - to create and instantly move to a new branch"+"that is identical to local master branch";
        String step6 = "Add your changes that are related to teh task";
        ...
        String step11 = "Create a Pull Request details from origin/new_branch_name into origin/master";
